...
EDA Toolkit is a Python library of utility functions designed to streamline exploratory data analysis. It covers directory management, data preprocessing, summary statistics, reporting, and a broad range of visualizations.
...
```python
from eda_toolkit import flex_corr_matrix, detect_outliers, generate_table1
...
summary = detect_outliers(df, method="iqr", flag_col="is_outlier")
print(summary)

# Summary statistics table
table1 = generate_table1(df, groupby_col="income")
print(table1)
```
