...
setup(
    ...
    install_requires=[
        ...
        "matplotlib>=3.5.3, <=3.9.2",  # Minimum version of matplotlib required
        "nbformat>=4.2.0, <=5.10.4",  # Minimum version of nbformat required
        "numpy>=1.21.6, <=2.1.2",  # Minimum version of numpy required
        "pandas>=1.3.5, <=2.2.3",  # Minimum version of pandas required
        "plotly>=5.18.0, <=5.24.1",  # Minimum version of plotly required
        "scikit-learn>=1.0.2, <=1.5.2",  # Minimum version of scikit-learn required
        "seaborn>=0.12.2, <=0.13.2",  # Minimum version of seaborn required
